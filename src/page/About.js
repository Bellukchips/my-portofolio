...
function About() {
  ...
  window.addEventListener("scroll", function () {
    const toTop = document.querySelector("a.up__to__top__btn");
    toTop.classList.toggle("active", this.window.scrollY > 0);
  });
  return (
    <div className="about component__space" id="About">
        ...
        <div className="row">
          <div className="col__2">
            <div className="about__box pointer relative">
              ...
              <div className="about__meta__card absolute">
                <h5 className="about__text">Muh Lukman Akbar Prihandoyo</h5>
                <div className="about about__btn btn">
                  <div className="row">
                    <div className="col__2">
                      <a href="https://www.instagram.com/lukman_12_01/">
                        <svg
                    ...
                    <div className="col__2">
                      <a href="https://www.linkedin.com/in/muh-lukman-akbar-prihandoyo/">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                          height="16"
            ...
            <div className="about__meta">
              ...
              <div className="about__button align__items__center">
                <div className="row">
                  <div className="col__2">
                    <a href="#">
                      <button className="about btn pointer btn__download">
                        Download Cv
                      </button>
                    </a>
                  </div>
                  <div className="col__2">
                    <a href="#">
                      <button className="about btn pointer btn__hire">
                        Hire Me
                      </button>
                    </a>
                  </div>
      ...
      <div className="up__btn">
        <a href="#" className="up__to__top__btn">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
